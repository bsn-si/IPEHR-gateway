...
//
// Solidity: function getDocByTime(bytes32 ehrID, uint8 docType, uint32 timestamp) view returns((uint8,bytes32,bytes32,uint32,bool,(uint8,bytes)[]))
...
//
// Solidity: function getDocByVersion(bytes32 ehrId, uint8 docType, bytes32 docBaseUIDHash, bytes32 version) view returns((uint8,bytes32,bytes32,uint32,bool,(uint8,bytes)[]))
...
//
// Solidity: function getDocLastByBaseID(bytes32 ehrId, uint8 docType, bytes32 docBaseUIDHash) view returns((uint8,bytes32,bytes32,uint32,bool,(uint8,bytes)[]))
...
//
// Solidity: function getEhrDocs(bytes32 ehrId, uint8 docType) view returns((uint8,bytes32,bytes32,uint32,bool,(uint8,bytes)[])[])
...
//
// Solidity: function getLastEhrDocByType(bytes32 ehrId, uint8 docType) view returns((uint8,bytes32,bytes32,uint32,bool,(uint8,bytes)[]))
...
// AddEhrDoc is a paid mutator transaction binding the contract method 0x4496ffc9.
//
// Solidity: function addEhrDoc((uint8,bytes32,bytes32,uint32,(uint8,bytes)[],address,bytes) p) returns()
...
// UserGroupCreate is a paid mutator transaction binding the contract method 0x62aa505f.
//
// Solidity: function userGroupCreate((bytes32,bytes,bytes,(uint8,bytes)[],address,bytes) p) returns()
