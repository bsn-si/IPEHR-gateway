//
// description: ANTLR4 parser grammar for Archetype Query Language (AQL) authors: Sebastian Iancu,
...
classExprOperand:
	...
	| VERSION variable = IDENTIFIER? (
		SYM_LEFT_BRACKET versionPredicate SYM_RIGHT_BRACKET
	)? # versionClassExpr;
...
// (deprecated)
top: TOP INTEGER direction = (FORWARD | BACKWARD)?;